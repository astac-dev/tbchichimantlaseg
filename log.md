# Notas del Proyecto - Telebachillerato Chichimantla Segundo

## Registro de Cambios y Tareas

- **2026-08-20**:
  - Se comentó temporalmente la funcionalidad de inicio de sesión (`login.php`) y su backend/callback (`callback.php`) para el servidor de Microsoft.
  - Se comentó el enlace de acceso ("Servicios Alumnos") en la página principal (`index.php`).
- **2026-08-21**:
